...
class Paging
{
	...
	public function __construct($pageNow,$pageSize,$tableName,$condition=null,$serachTarget="*")
	{
	...
	{
		$sql = "SELECT ".$this->serachTarget." FROM ".$this->tableName." ".$this->condition." LIMIT ".($this->pageSize * ($this->pageNow - 1)).",".$this->pageSize;
	...
	{
		//分页块的开头
		$pageDivStart = '<div class="text-center page">'."\r\n".'<ul>'."\r\n";
		//分页块中间部分
		$pageDivContent = "";
		//分页块的结尾
		$pageDivEnd = '</ul>'."\r\n".'</div>'."\r\n";
